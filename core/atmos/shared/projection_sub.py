...
def projection_sub(dct, limit, four_corners=True, target_pixel_size = None):
    ...
    if target_pixel_size is None:
        ...
        yrange = [yrange_raw[1]+pixel_size[1]-(yrange_raw[1] % pixel_size[1]), \
                  yrange_raw[0] - (yrange_raw[0] % pixel_size[1])]
        ...
        xmod = [xscene[0] % pixel_size[0], xscene[1] % pixel_size[0]]
        ymod = [yscene[0] % pixel_size[1], yscene[1] % pixel_size[1]]

        x_grid_off = x_grid_off[0]+xmod[0], x_grid_off[1]+xmod[0]
        y_grid_off = y_grid_off[0]+ymod[0], y_grid_off[1]+ymod[0]
        ...
        xrange = [xrange_raw[0] - (xrange_raw[0] % target_pixel_size[0]), \
                  xrange_raw[1]+target_pixel_size[0]-(xrange_raw[1] % target_pixel_size[0])]
        yrange = [yrange_raw[1]+target_pixel_size[1]-(yrange_raw[1] % target_pixel_size[1]), \
        ...
        xmod = [xscene[0] % target_pixel_size[0], xscene[1] % target_pixel_size[0]]
        ymod = [yscene[0] % target_pixel_size[1], yscene[1] % target_pixel_size[1]]

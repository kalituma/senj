...
from core.graph import PINIT, PEND, PR, LINK, build_graph_func, get_procs, get_ops_args, get_successors_by_relation
...
class GraphManager:
    def __init__(self, config:dict, schema_map:dict):
        ...
        self._ops:list[tuple] = [get_ops_args(self._graph, proc) for proc in self.procs]
    ...
    def __getitem__(self, idx):
        return self._get_item(self.procs[idx])

    def _get_item(self, proc:str) -> ProcessingSource:

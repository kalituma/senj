...
class TestSubset(unittest.TestCase):
    ...
    def test_safe_subset_for_input(self):
        ...
        with self.subTest(msg='subset with bounds'):
            ...
            subset_op = Subset(bounds=[412290, 3914633, 476647, 3869088], bounds_epsg=32652, copy_meta=True)
            ...
            subset_op =Subset(bounds=[421531, 3919583, 479618, 3866777], bounds_epsg=32652, copy_meta=True)
            subset_op.module_type = 'snap'
            snap_tif_raster = subset_op(snap_tif_raster, context)

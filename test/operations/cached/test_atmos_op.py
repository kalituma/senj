...
class TestAtmosCorr(unittest.TestCase):
    ...
    def test_atmos_corr_to_s2_dim(self):
        ...
        raster = AtmosCorr(band_names_or_indices=['B1', 'B2', 'B3', 'B4', 'B5'], band_slots=['B1', 'B2', 'B3', 'B4', 'B5'],
    ...
    def test_atmos_corr_to_s2_tif(self):
        ...
        AtmosCorr(band_names_or_indices=[1,2,3],
                  band_slots=['B2', 'B3', 'B4'],
                  det_bword='*detector*',
    ...
    def test_atmos_corr_to_wv(self):
        ...
        raster = AtmosCorr(band_names_or_indices=['BAND_B', 'BAND_G', 'BAND_R'],
    ...
    def test_atmos_corr_to_ps(self):
        ...
        raster = AtmosCorr(band_names_or_indices=['band_1', 'band_2', 'band_3', 'band_4'],
